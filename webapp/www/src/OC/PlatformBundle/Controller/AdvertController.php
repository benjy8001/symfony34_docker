...
class AdvertController extends Controller
{
	...
	public function addAction(Request $request)
	{
		...
		$response = $this->render('OCPlatformBundle:Advert:add.html.twig', array(
	...
	public function editAction(Advert $advert, Request $request)
	{
		...
		$reponse = $this->render('OCPlatformBundle:Advert:edit.html.twig', array(
		  'advert' => $advert,
		  'form' => $form->createView(),
		));
		$response->setSharedMaxAge(3600);
	...
	public function deleteAction(Advert $advert, Request $request)
	{
		...
		$response = $this->render('OCPlatformBundle:Advert:delete.html.twig', array(
			'advert' => $advert,
			'form'   => $form->createView(),
		));
		$response->setSharedMaxAge(3600);
